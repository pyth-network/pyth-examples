 ...
 * @category layers
 */
export const layerSocket = Client.layerTracer;
/**
 * @since 1.0.0
 * @category layers
 */
export const layerWebSocket = (url = "ws://localhost:34437") => Client.layerTracer.pipe(Layer.provide(Socket.layerWebSocket(url)));
/**
 * @since 1.0.0
 * @category layers
 */
