 ...
 * @category model
 */
export class PlutusV1 extends /*#__PURE__*/Schema.TaggedClass("PlutusV1")("PlutusV1", {
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transform(CDDLSchema, /*#__PURE__*/Schema.typeSchema(PlutusV1), {
  strict: true,
  encode: toI => toI.bytes,
  decode: fromA => new PlutusV1({
    bytes: fromA
  })
});
/**
...
export const arbitrary = /*#__PURE__*/FastCheck.uint8Array({
  minLength: 1,
  maxLength: 512
}).map(script => new PlutusV1({
  bytes: script
}));
//# sourceMappingURL=PlutusV1.js.map