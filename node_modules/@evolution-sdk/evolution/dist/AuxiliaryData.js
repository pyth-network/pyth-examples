 ...
 * @category model
 */
export class ConwayAuxiliaryData extends /*#__PURE__*/Schema.TaggedClass("ConwayAuxiliaryData")("ConwayAuxiliaryData", {
  metadata: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.typeSchema(Metadata.Metadata)),
  nativeScripts: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.Array(NativeScripts.NativeScript)),
  plutusV1Scripts: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.Array(PlutusV1.PlutusV1)),
  plutusV2Scripts: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.Array(PlutusV2.PlutusV2)),
  plutusV3Scripts: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.Array(PlutusV3.PlutusV3))
}) {
  /**
   * @since 2.0.0
   * @category json
  ...
  [Equal.symbol](that) {
    ...
    return metadataMapEquals(this.metadata, that.metadata) && arrayEquals(this.nativeScripts, that.nativeScripts) && arrayEquals(this.plutusV1Scripts, that.plutusV1Scripts) && arrayEquals(this.plutusV2Scripts, that.plutusV2Scripts) && arrayEquals(this.plutusV3Scripts, that.plutusV3Scripts);
  }
  /**
   * @since 2.0.0
   * @category hash
   */
  [Hash.symbol]() {
    return Hash.cached(this, Hash.combine(Hash.combine(Hash.combine(Hash.combine(hashMetadataMap(this.metadata))(hashArray(this.nativeScripts)))(hashArray(this.plutusV1Scripts)))(hashArray(this.plutusV2Scripts)))(hashArray(this.plutusV3Scripts)));
  }
}
/**
 ...
 * @category model
 */
export class ShelleyMAAuxiliaryData extends /*#__PURE__*/Schema.TaggedClass("ShelleyMAAuxiliaryData")("ShelleyMAAuxiliaryData", {
  metadata: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.typeSchema(Metadata.Metadata)),
  nativeScripts: /*#__PURE__*/Schema.optional(/*#__PURE__*/Schema.Array(NativeScripts.NativeScript))
}) {
  /**
 ...
 * @category model
 */
export class ShelleyAuxiliaryData extends /*#__PURE__*/Schema.TaggedClass("ShelleyAuxiliaryData")("ShelleyAuxiliaryData", {
  metadata: /*#__PURE__*/Schema.typeSchema(Metadata.Metadata)
}) {
  /**
   * @since 2.0.0
   * @category json
 ...
 * @category model
 */
export const AuxiliaryData = /*#__PURE__*/Schema.Union(ConwayAuxiliaryData, ShelleyMAAuxiliaryData, ShelleyAuxiliaryData);
/**
...
export const CDDLSchema = /*#__PURE__*/CBOR.tag(259, /*#__PURE__*/Schema.MapFromSelf({
  key: CBOR.Integer,
...
const AnyEraCDDL = /*#__PURE__*/Schema.Union(CDDLSchema,
...
Metadata.CDDLSchema);
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(AnyEraCDDL, Schema.typeSchema(AuxiliaryData), {
  strict: true,
  encode: auxData => E.gen(function* () {
      ...
      case "ShelleyMAAuxiliaryData":
        {
          ...
          const encodedMetadata = auxData.metadata !== undefined ? new Map(yield* ParseResult.encodeEither(Metadata.FromCDDL)(auxData.metadata)) : new Map();
  ...
  decode: input => E.gen(function* () {
    // Conway tag(259)
    if (CBOR.isTag(input) && input.tag === 259) {
      const struct = input.value;
      const meta = struct.get(0n);
      const metadata = meta ? yield* ParseResult.decodeEither(Metadata.FromCDDL)(meta) : undefined;
      const nScripts = struct.get(1n);
      const nativeScripts = nScripts ? yield* ParseResult.decodeUnknownEither(Schema.Array(NativeScripts.FromCDDL))(nScripts) : undefined;
      const rawPlutusV1 = struct.get(2n);
      const plutusV1Scripts = rawPlutusV1 ? yield* ParseResult.decodeUnknownEither(Schema.Array(PlutusV1.FromCDDL))(rawPlutusV1) : undefined;
      const rawPlutusV2 = struct.get(3n);
      const plutusV2Scripts = rawPlutusV2 ? yield* ParseResult.decodeUnknownEither(Schema.Array(PlutusV2.FromCDDL))(rawPlutusV2) : undefined;
      const rawPlutusV3 = struct.get(4n);
      const plutusV3Scripts = rawPlutusV3 ? yield* ParseResult.decodeUnknownEither(Schema.Array(PlutusV3.FromCDDL))(rawPlutusV3) : undefined;
    ...
    if (Array.isArray(input)) {
      ...
      return new ShelleyMAAuxiliaryData({
        metadata,
        nativeScripts
      });
    }
 ...
 * @category constructors
 */
export const conway = input => new ConwayAuxiliaryData({
  ...input
});
/**
 ...
 * @category constructors
 */
export const shelleyMA = input => new ShelleyMAAuxiliaryData({
  ...input
});
/**
 ...
 * @category constructors
 */
export const shelley = input => new ShelleyAuxiliaryData({
 ...
 * @category arbitrary
 */
export const conwayArbitrary = /*#__PURE__*/FastCheck.record({
  metadata: FastCheck.option(Metadata.arbitrary, {
    nil: undefined
  }),
  ...
  plutusV1Scripts: FastCheck.option(FastCheck.array(PlutusV1.arbitrary, {
    maxLength: 3
  }), {
    nil: undefined
  }),
  plutusV2Scripts: FastCheck.option(FastCheck.array(PlutusV2.arbitrary, {
    maxLength: 3
  }), {
    nil: undefined
  }),
  plutusV3Scripts: FastCheck.option(FastCheck.array(PlutusV3.arbitrary, {
    maxLength: 3
  }), {
    nil: undefined
  })
}).map(r => new ConwayAuxiliaryData(r));
export const shelleyMAArbitrary = /*#__PURE__*/FastCheck.record({
  metadata: FastCheck.option(Metadata.arbitrary, {
    nil: undefined
  }),
  nativeScripts: FastCheck.option(FastCheck.array(NativeScripts.arbitrary, {
  ...
  return hasMeta;
}).map(r => new ShelleyMAAuxiliaryData({
...
export const shelleyArbitrary = /*#__PURE__*/Metadata.arbitrary.map(metadata => new ShelleyAuxiliaryData({
  metadata
}));
/**
 ...
 * @category arbitrary
 */
export const arbitrary = /*#__PURE__*/FastCheck.oneof(conwayArbitrary, shelleyMAArbitrary, shelleyArbitrary);
// ============================================================================
// Parsing Functions
// ============================================================================
/**
 ...
 * @category parsing
 */
export const fromCBORBytes = (bytes, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.decodeSync(FromCBORBytes(options))(bytes);
/**
 ...
 * @category encoding
 */
export const toCBORBytes = (data, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.encodeSync(FromCBORBytes(options))(data);
/**
