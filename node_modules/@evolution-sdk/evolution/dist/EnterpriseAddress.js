 ...
 * @category schemas
 */
export class EnterpriseAddress extends /*#__PURE__*/Schema.TaggedClass("EnterpriseAddress")("EnterpriseAddress", {
  ...
  [Equal.symbol](that) {
    return that instanceof EnterpriseAddress && Equal.equals(this.networkId, that.networkId) && Equal.equals(this.paymentCredential, that.paymentCredential);
  }
  [Hash.symbol]() {
    return Hash.combine(Hash.hash(this.networkId))(Hash.hash(this.paymentCredential));
  }
}
export const FromBytes = /*#__PURE__*/Schema.transformOrFail(Schema.typeSchema(Bytes29.BytesFromHex), Schema.typeSchema(EnterpriseAddress), {
  strict: true,
  ...
  decode: (_, __, ___, fromA) => Eff.gen(function* () {
 ...
 * @category testing
 */
export const arbitrary = /*#__PURE__*/FastCheck.tuple(NetworkId.arbitrary, Credential.arbitrary).map(([networkId, paymentCredential]) => new EnterpriseAddress({
  networkId,
  paymentCredential
}));
// ============================================================================
