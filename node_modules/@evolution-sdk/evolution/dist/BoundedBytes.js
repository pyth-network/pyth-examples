 ...
 * @category schemas
 */
export const BoundedBytesSchema = /*#__PURE__*/Schema.Uint8ArrayFromSelf.pipe(/*#__PURE__*/Schema.filter(bytes => bytes.length >= 0 && bytes.length <= 64, {
  message: () => "BoundedBytes must be between 0 and 64 bytes in length"
}));
//# sourceMappingURL=BoundedBytes.js.map