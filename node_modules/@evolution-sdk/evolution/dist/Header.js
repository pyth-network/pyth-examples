 ...
 * @category model
 */
export class Header extends /*#__PURE__*/Schema.TaggedClass()("Header", {
  ...
  [Equal.symbol](that) {
    return that instanceof Header && Equal.equals(this.headerBody, that.headerBody) && Equal.equals(this.bodySignature, that.bodySignature);
  }
  [Hash.symbol]() {
 ...
 * @category predicates
 */
export const isHeader = value => value instanceof Header;
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(/*#__PURE__*/Schema.Tuple(/*#__PURE__*/Schema.encodedSchema(HeaderBody.FromCDDL),
// header_body using HeaderBody CDDL schema
CBOR.ByteArray // body_signature as bytes
), /*#__PURE__*/Schema.typeSchema(Header), {
  strict: true,
  encode: toA => Effect.gen(function* () {
    ...
    return [headerBodyCddl, bodySignatureBytes];
  }),
  decode: ([headerBodyCddl, bodySignatureBytes]) => Effect.gen(function* () {
 ...
 * @category parsing
 */
export const fromCBORBytes = (bytes, options) => Schema.decodeSync(FromBytes(options))(bytes);
/**
 ...
 * @category parsing
 */
export const fromCBORHex = (hex, options) => Schema.decodeSync(FromHex(options))(hex);
// ============================================================================
// Encoding Functions
// ============================================================================
/**
 ...
 * @category encoding
 */
export const toCBORBytes = (header, options) => Schema.encodeSync(FromBytes(options))(header);
/**
 ...
 * @category encoding
 */
export const toCBORHex = (header, options) => Schema.encodeSync(FromHex(options))(header);
