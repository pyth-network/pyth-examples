 ...
 * @category model
 */
export class PolicyId extends /*#__PURE__*/Schema.TaggedClass()("PolicyId", {
 ...
 * @category schemas
 */
export const FromBytes = /*#__PURE__*/Schema.transform(Schema.typeSchema(Hash28.BytesFromHex), Schema.typeSchema(PolicyId), {
  strict: true,
  decode: hash => new PolicyId({
    hash
  }, {
 ...
 * @category predicates
 */
export const isPolicyId = /*#__PURE__*/Schema.is(PolicyId);
/**
...
//# sourceMappingURL=PolicyId.js.map