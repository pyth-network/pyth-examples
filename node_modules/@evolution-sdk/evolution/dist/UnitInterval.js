 ...
 * @category model
 */
export class UnitInterval extends /*#__PURE__*/Schema.Class("UnitInterval")({
...
export const CDDLSchema = /*#__PURE__*/CBOR.tag(30, /*#__PURE__*/Schema.Tuple(CBOR.Integer, CBOR.Integer));
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, Schema.typeSchema(UnitInterval), {
  strict: true,
  encode: (_, __, ___, unitInterval) => Effect.succeed({
    _tag: "Tag",
    tag: 30,
    value: [unitInterval.numerator, unitInterval.denominator]
  }),
  decode: (_, __, ___, taggedValue) => Effect.gen(function* () {
    // Validate tag number
    if (taggedValue.tag !== 30) {
      return yield* Effect.fail(new ParseResult.Type(UnitInterval.ast, taggedValue, `Expected tag 30 for UnitInterval, got ${taggedValue.tag}`));
    }
 ...
 */
export const toBigDecimal = interval => BigDecimal.unsafeDivide(BigDecimal.fromBigInt(interval.numerator), BigDecimal.fromBigInt(interval.denominator));
/**
 ...
 */
export const fromBigDecimal = value => {
 ...
 * @category arbitrary
 */
export const arbitrary = /*#__PURE__*/FastCheck.bigInt({
  min: 1n,
  max: 1000000n
}).chain(denominator => FastCheck.bigInt({
  min: 0n,
  max: denominator
}).map(numerator => new UnitInterval({
  numerator,
  denominator
})));
