 ...
 * @category model
 */
export class MultiAsset extends /*#__PURE__*/Schema.Class("MultiAsset")({
 ...
 */
export const empty = () => new MultiAsset({
  map: new Map()
});
/**
 ...
 */
export const addAsset = (multiAsset, policyId, assetName, amount) => {
 ...
 * @category transformation
 */
export const getAsset = (multiAsset, policyId, assetName) => {
 ...
 * @category predicates
 */
export const hasAsset = (multiAsset, policyId, assetName) => {
 ...
 * @category transformation
 */
export const getPolicyIds = multiAsset => Array.from(multiAsset.map.keys());
/**
 ...
 * @category transformation
 */
export const getAssetsByPolicy = (multiAsset, policyId) => {
  const assetMap = multiAsset.map.get(policyId);
 ...
 * @category predicates
 */
export const is = value => Schema.is(MultiAsset)(value);
/**
 ...
 * @category arbitrary
 */
export const arbitrary = /*#__PURE__*/FastCheck.uniqueArray(PolicyId.arbitrary, {
  minLength: 1,
  maxLength: 5,
  ...
  FastCheck.array(FastCheck.bigInt({
    min: 1n,
    ...
    const entries = names.map((n, i) => [n, amounts[i]]);
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(/*#__PURE__*/Schema.MapFromSelf({
  key: CBOR.ByteArray,
  value: /*#__PURE__*/Schema.MapFromSelf({
    key: CBOR.ByteArray,
    value: CBOR.Integer
  })
}), /*#__PURE__*/Schema.typeSchema(MultiAsset), {
  strict: true,
  encode: (toI, _, __, toA) => Eff.gen(function* () {
