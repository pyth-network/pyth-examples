 ...
 * @category model
 */
export class ProposalProcedures extends /*#__PURE__*/Schema.TaggedClass()("ProposalProcedures", {
  procedures: /*#__PURE__*/Schema.Array(ProposalProcedure.ProposalProcedure).pipe(/*#__PURE__*/Schema.filter(arr => arr.length > 0, {
    message: () => "ProposalProcedures must contain at least one procedure"
  }))
}) {
  toJSON() {
    return {
      _tag: "ProposalProcedures",
 ...
 * @category schemas
 */
export const CDDLSchema = /*#__PURE__*/Schema.Array(ProposalProcedure.CDDLSchema);
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, /*#__PURE__*/Schema.typeSchema(ProposalProcedures), {
  strict: true,
  encode: toA => Eff.all(toA.procedures.map(procedure => ParseResult.encode(ProposalProcedure.FromCDDL)(procedure))),
  decode: fromA => Eff.gen(function* () {
    const procedures = yield* Eff.all(fromA.map(procedureTuple => ParseResult.decode(ProposalProcedure.FromCDDL)(procedureTuple)));
 ...
 * @category helpers
 */
export const single = (deposit, rewardAccount, governanceAction, anchor) => {
  return new ProposalProcedures({
    procedures: [new ProposalProcedure.ProposalProcedure({
      deposit,
      rewardAccount,
      governanceAction,
      anchor
...
//# sourceMappingURL=ProposalProcedures.js.map