 ...
 * @category schemas
 */
export const Uint8Schema = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= UINT8_MIN && value <= UINT8_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Uint8",
 ...
 * @category arbitrary
 */
export const Uint8Generator = /*#__PURE__*/FastCheck.bigInt({
  min: UINT8_MIN,
  max: UINT8_MAX
}).map(Uint8Make);
export const UINT16_MIN = 0n;
export const UINT16_MAX = 65535n;
export const Uint16Schema = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= UINT16_MIN && value <= UINT16_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Uint16",
...
export const Uint16Arbitrary = /*#__PURE__*/FastCheck.bigInt({
  min: UINT16_MIN,
  max: UINT16_MAX
}).map(Uint16Make);
export const UINT32_MIN = 0n;
export const UINT32_MAX = 4294967295n;
export const Uint32Schema = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= UINT32_MIN && value <= UINT32_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Uint32",
...
export const Uint32Arbitrary = /*#__PURE__*/FastCheck.bigInt({
  min: UINT32_MIN,
  max: UINT32_MAX
}).map(Uint32Make);
export const UINT64_MIN = 0n;
export const UINT64_MAX = 18446744073709551615n;
export const Uint64Schema = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(bigint => bigint >= UINT64_MIN && bigint <= UINT64_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Uint64",
...
export const Uint64Arbitrary = /*#__PURE__*/FastCheck.bigInt({
  min: UINT64_MIN,
  max: UINT64_MAX
}).map(Uint64Make);
export const INT8_MIN = -128n;
export const INT8_MAX = 127n;
export const Int8 = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= INT8_MIN && value <= INT8_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Int8",
...
export const Int8Generator = /*#__PURE__*/FastCheck.bigInt({
  min: INT8_MIN,
  max: INT8_MAX
}).map(Int8Make);
export const INT16_MIN = -32768n;
export const INT16_MAX = 32767n;
export const Int16 = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= INT16_MIN && value <= INT16_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Int16",
...
export const Int16Generator = /*#__PURE__*/FastCheck.bigInt({
  min: INT16_MIN,
  max: INT16_MAX
}).map(Int16Make);
export const INT32_MIN = -2147483648n;
export const INT32_MAX = 2147483647n;
export const Int32 = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= INT32_MIN && value <= INT32_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Int32",
...
export const Int32Generator = /*#__PURE__*/FastCheck.bigInt({
  min: INT32_MIN,
  max: INT32_MAX
}).map(Int32Make);
export const INT64_MIN = -9223372036854775808n;
export const INT64_MAX = 9223372036854775807n;
export const Int64 = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(bigint => bigint >= INT64_MIN && bigint <= INT64_MAX), /*#__PURE__*/Schema.annotations({
  identifier: "Int64",
...
export const Int64Generator = /*#__PURE__*/FastCheck.bigInt({
  min: INT64_MIN,
  max: INT64_MAX
}).map(Int64Make);
/**
 ...
 * @category schemas
 */
export const NonNegativeInteger = /*#__PURE__*/Schema.BigInt.pipe(/*#__PURE__*/Schema.filter(value => value >= 0n), /*#__PURE__*/Schema.annotations({
