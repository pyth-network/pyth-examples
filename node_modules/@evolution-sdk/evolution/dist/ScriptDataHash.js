 ...
 * @category model
 */
export class ScriptDataHash extends /*#__PURE__*/Schema.TaggedClass()("ScriptDataHash", {
 ...
 * @category schemas
 */
export const FromBytes = /*#__PURE__*/Schema.transform(Schema.typeSchema(Bytes32.BytesFromHex), Schema.typeSchema(ScriptDataHash), {
  strict: true,
  decode: bytes => new ScriptDataHash({
    hash: bytes
  }, {
 ...
 * @category schemas
 */
export const FromHex = /*#__PURE__*/Schema.compose(Bytes32.BytesFromHex,
// string -> Bytes32
 ...
 * @category predicates
 */
export const isScriptDataHash = /*#__PURE__*/Schema.is(ScriptDataHash);
/**
...
//# sourceMappingURL=ScriptDataHash.js.map