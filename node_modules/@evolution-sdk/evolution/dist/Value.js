 ...
 * @category schemas
 */
export class OnlyCoin extends /*#__PURE__*/Schema.TaggedClass("OnlyCoin")("OnlyCoin", {
  coin: Coin.Coin
}) {
  toJSON() {
    return {
...
export class WithAssets extends /*#__PURE__*/Schema.TaggedClass("WithAssets")("WithAssets", {
  coin: Coin.Coin,
...
export const Value = /*#__PURE__*/Schema.Union(OnlyCoin, WithAssets);
/**
 ...
 */
export const onlyCoin = ada => new OnlyCoin({
  coin: ada
});
/**
 ...
 * @category constructors
 */
export const withAssets = (ada, assets) => new WithAssets({
  coin: ada,
  assets
});
/**
 ...
 * @category predicates
 */
export const isAdaOnly = value => value._tag === "OnlyCoin";
/**
 ...
 * @category predicates
 */
export const hasAssets = value => value._tag === "WithAssets";
/**
 ...
 * @category predicates
 */
export const is = value => Schema.is(Value)(value);
/**
 ...
 * @category generators
 */
export const arbitrary = /*#__PURE__*/FastCheck.oneof(/*#__PURE__*/Coin.arbitrary.map(coin => new OnlyCoin({
  coin
}, {
  disableValidation: true
})), /*#__PURE__*/FastCheck.record({
...
export const CDDLSchema = /*#__PURE__*/Schema.Union(CBOR.Integer, /*#__PURE__*/Schema.Tuple(CBOR.Integer, /*#__PURE__*/Schema.encodedSchema(MultiAsset.FromCDDL // MultiAsset CDDL structure
)));
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, /*#__PURE__*/Schema.typeSchema(Value), {
  strict: true,
  encode: toI => Eff.gen(function* () {
    ...
    if (toI._tag === "OnlyCoin") {
      ...
      return [toI.coin, outerMap]; // Return as tuple
    }
  }),
  decode: fromA => Eff.gen(function* () {
    if (typeof fromA === "bigint") {
      ...
      return new WithAssets({
        ...
        assets: new MultiAsset.MultiAsset({
          map: result
        })
      });
    }
