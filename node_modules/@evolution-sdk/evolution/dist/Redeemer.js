 ...
 * @category model
 */
export const RedeemerTag = /*#__PURE__*/Schema.Literal("spend", "mint", "cert", "reward", "vote", "propose").annotations({
 ...
 * @category model
 */
export class ExUnits extends /*#__PURE__*/Schema.Class("Redeemer.ExUnits")({
  mem: /*#__PURE__*/Numeric.Uint64Schema.annotations({
    identifier: "Redeemer.ExUnits.Memory",
    title: "Memory Units",
    description: "Memory units consumed by script execution"
  }),
  steps: /*#__PURE__*/Numeric.Uint64Schema.annotations({
 ...
 * @category model
 */
export class Redeemer extends /*#__PURE__*/Schema.Class("Redeemer")({
  tag: RedeemerTag,
  index: /*#__PURE__*/Numeric.Uint64Schema.annotations({
  ...
  data: /*#__PURE__*/PlutusData.DataSchema.annotations({
   ...
   */
  [Equal.symbol](that) {
    return that instanceof Redeemer && this.tag === that.tag && this.index === that.index && PlutusData.equals(this.data, that.data) && Equal.equals(this.exUnits, that.exUnits);
  }
  /**
 ...
 * @category utilities
 */
export const integerToTag = value => {
  switch (value) {
    case 0n:
      return "spend";
    case 1n:
    ...
    case 5n:
      return "propose";
    default:
      throw new Error(`Invalid redeemer tag: ${value}. Must be 0 (spend), 1 (mint), 2 (cert), 3 (reward), 4 (vote), or 5 (propose)`);
  }
};
/**
 ...
 * @category schemas
 */
export const CDDLSchema = /*#__PURE__*/Schema.Tuple(CBOR.Integer.annotations({
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, /*#__PURE__*/Schema.typeSchema(Redeemer), {
  strict: true,
  encode: redeemer => Effect.gen(function* () {
    const tagInteger = tagToInteger(redeemer.tag);
    const dataCBOR = yield* ParseResult.encode(PlutusData.FromCDDL)(redeemer.data);
    return [tagInteger, redeemer.index, dataCBOR, [redeemer.exUnits.mem, redeemer.exUnits.steps]];
  }),
  decode: ([tagInteger, index, dataCBOR, [mem, steps]]) => Effect.gen(function* () {
 ...
 */
export const spend = (index, data, exUnits) => new Redeemer({
  tag: "spend",
  index,
  data,
  exUnits
 ...
 * @category constructors
 */
export const mint = (index, data, exUnits) => new Redeemer({
  tag: "mint",
  index,
  data,
  exUnits
 ...
 * @category constructors
 */
export const cert = (index, data, exUnits) => new Redeemer({
  tag: "cert",
  index,
  data,
  exUnits
 ...
 * @category constructors
 */
export const reward = (index, data, exUnits) => new Redeemer({
  tag: "reward",
  index,
  data,
  exUnits
 ...
 * @category predicates
 */
export const isSpend = redeemer => redeemer.tag === "spend";
/**
 ...
 * @category predicates
 */
export const isMint = redeemer => redeemer.tag === "mint";
/**
 ...
 * @category predicates
 */
export const isCert = redeemer => redeemer.tag === "cert";
/**
 ...
 * @category predicates
 */
export const isReward = redeemer => redeemer.tag === "reward";
// ============================================================================
// Transformations
// ============================================================================
/**
 ...
 */
export const toCBORBytes = (redeemer, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.encodeSync(FromCBORBytes(options))(redeemer);
/**
 ...
 * @category transformation
 */
export const toCBORHex = (redeemer, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.encodeSync(FromCBORHex(options))(redeemer);
/**
 ...
 * @category generators
 */
export const arbitraryRedeemerTag = /*#__PURE__*/FastCheck.constantFrom("spend", "mint", "cert", "reward");
/**
 ...
 * @category generators
 */
export const arbitraryExUnits = /*#__PURE__*/FastCheck.tuple(FastCheck.bigInt({
  min: 0n,
  max: 10000000n
}),
// memory
