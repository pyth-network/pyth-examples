 ...
 * @category model
 */
export const AddressEras = /*#__PURE__*/Schema.Union(BaseAddress.BaseAddress, EnterpriseAddress.EnterpriseAddress, PointerAddress.PointerAddress, RewardAccount.RewardAccount, ByronAddress.ByronAddress);
export const isAddress = /*#__PURE__*/Schema.is(AddressEras);
/**
 ...
 * @category schema
 */
export const FromBytes = /*#__PURE__*/Schema.transformOrFail(Schema.Uint8ArrayFromSelf, /*#__PURE__*/Schema.typeSchema(AddressEras), {
  strict: true,
  encode: (_, __, ___, toA) => {
    switch (toA._tag) {
      case "BaseAddress":
  ...
  decode: (_, __, ast, fromA) => Eff.gen(function* () {
 ...
 * @category schema
 */
export const FromHex = /*#__PURE__*/Schema.compose(Schema.Uint8ArrayFromHex, FromBytes);
/**
 ...
 * @category schema
 */
export const FromBech32 = /*#__PURE__*/Schema.transformOrFail(Schema.String, Schema.typeSchema(AddressEras), {
  strict: true,
  encode: (_, __, ast, toA) => Eff.gen(function* () {
    ...
    switch (toA._tag) {
      ...
      case "RewardAccount":
        ...
        break;
      case "ByronAddress":
        return yield* ParseResult.fail(new ParseResult.Type(ast, toA, "Byron addresses do not support Bech32 encoding"));
    }
    const result = yield* Eff.try({
      ...
      catch: error => new ParseResult.Type(ast, toA, `Failed to encode Bech32: ${error.message}`)
    });
    return result;
  }),
  decode: (fromA, _, ast) => Eff.gen(function* () {
    const result = yield* Eff.try({
      try: () => {
      ...
      catch: error => new ParseResult.Type(ast, fromA, `Failed to decode Bech32: ${error.message}`)
    });
 ...
 *
 */
export const arbitrary = /*#__PURE__*/FastCheck.oneof(BaseAddress.arbitrary, EnterpriseAddress.arbitrary, PointerAddress.arbitrary, RewardAccount.arbitrary);
// ============================================================================
// Parsing Functions
// ============================================================================
/**
...
//# sourceMappingURL=AddressEras.js.map