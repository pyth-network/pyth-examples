 ...
 * @category schemas
 */
export class IPv6 extends /*#__PURE__*/Schema.TaggedClass()("IPv6", {
...
export const FromBytes = /*#__PURE__*/Schema.transform(Schema.typeSchema(Bytes16.BytesFromHex), Schema.typeSchema(IPv6), {
  strict: true,
  decode: bytes => new IPv6({
    bytes
  }, {
...
export const FromHex = /*#__PURE__*/Schema.compose(Bytes16.BytesFromHex,
 ...
 * @category predicates
 */
export const isIPv6 = /*#__PURE__*/Schema.is(IPv6);
/**
