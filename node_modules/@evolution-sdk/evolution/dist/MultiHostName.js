 ...
 * @category model
 */
export class MultiHostName extends /*#__PURE__*/Schema.TaggedClass()("MultiHostName", {
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(Schema.Tuple(Schema.Literal(2n),
// tag (literal 2)
Schema.String // dns_name (string)
  ...
  encode: toA => Eff.gen(function* () {
    ...
    return yield* Eff.succeed([2n, dnsName]);
  }),
  decode: ([, dnsNameValue]) => Eff.gen(function* () {
    const dnsName = yield* ParseResult.decode(DnsName.DnsName)(dnsNameValue);
    return yield* Eff.succeed(new MultiHostName({
      dnsName
    }));
  })
}).annotations({
