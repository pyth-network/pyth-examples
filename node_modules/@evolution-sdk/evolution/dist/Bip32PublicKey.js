 ...
 * @category errors
 */
export class Bip32PublicKeyError extends /*#__PURE__*/Data.TaggedError("Bip32PublicKeyError") {}
/**
 ...
 * @category schemas
 */
export class Bip32PublicKey extends /*#__PURE__*/Schema.TaggedClass()("Bip32PublicKey", {
 ...
 * @category schemas
 */
export const FromBytes = /*#__PURE__*/Schema.transform(Schema.typeSchema(Bytes64.BytesFromHex), Schema.typeSchema(Bip32PublicKey), {
  strict: true,
  decode: bytes => new Bip32PublicKey({
    bytes
  }, {
 ...
 * @category schemas
 */
export const FromHex = /*#__PURE__*/Schema.compose(Bytes64.BytesFromHex,
// string -> Bytes64
 ...
 * @category encoding
 */
export const toRawBytes = bip32PublicKey => {
 ...
 * @category derivation
 */
export const deriveChild = (bip32PublicKey, index) => {
 ...
 * @category accessors
 */
export const chainCode = bip32PublicKey => {
 ...
 * @category accessors
 */
export const publicKey = bip32PublicKey => {
  return bip32PublicKey.bytes.slice(0, 32);
};
// ============================================================================
// Either Namespace
...
(function (Either) {
   ...
   * @category derivation
   */
  Either.deriveChild = (bip32PublicKey, index) => E.gen(function* () {
    if (index >= 0x80000000) {
      return yield* E.left(new Bip32PublicKeyError({
