 ...
 * @category model
 */
export class ProposalProcedure extends /*#__PURE__*/Schema.Class("ProposalProcedure")({
  deposit: Coin.Coin,
  rewardAccount: RewardAccount.FromBech32,
  governanceAction: GovernanceAction.GovernanceAction,
  anchor: /*#__PURE__*/Schema.NullOr(Anchor.Anchor)
}) {
  /**
   ...
   */
  [Equal.symbol](that) {
    return that instanceof ProposalProcedure && Equal.equals(this.deposit, that.deposit) && Equal.equals(this.rewardAccount, that.rewardAccount) && Equal.equals(this.governanceAction, that.governanceAction) && Equal.equals(this.anchor, that.anchor);
  }
  /**
   ...
   */
  [Hash.symbol]() {
    return Hash.cached(this, Hash.combine(Hash.combine(Hash.combine(Hash.hash(this.deposit))(Hash.hash(this.rewardAccount)))(Hash.hash(this.governanceAction)))(Hash.hash(this.anchor)));
  }
}
/**
 ...
 * @category schemas
 */
export const CDDLSchema = /*#__PURE__*/Schema.Tuple(CBOR.Integer,
// deposit: coin
CBOR.ByteArray,
/*#__PURE__*/
// reward_account (raw bytes)
Schema.encodedSchema(GovernanceAction.CDDLSchema),
/*#__PURE__*/
// governance_action using proper CDDL schema
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, /*#__PURE__*/Schema.typeSchema(ProposalProcedure), {
  strict: true,
  encode: procedure => Eff.gen(function* () {
    ...
    return [depositBigInt, rewardAccountBytes, governanceActionCDDL, anchorCDDL];
  }),
  decode: procedureTuple => Eff.gen(function* () {
 ...
 * @category encoding
 */
export const toCBORBytes = (procedure, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.encodeSync(FromCBORBytes(options))(procedure);
/**
 ...
 * @category encoding
 */
export const toCBORHex = (procedure, options = CBOR.CML_DEFAULT_OPTIONS) => Schema.encodeSync(FromCBORHex(options))(procedure);
