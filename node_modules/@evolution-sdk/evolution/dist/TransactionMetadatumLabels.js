 ...
 * @category schemas
 */
export class TransactionMetadatumLabels extends /*#__PURE__*/Schema.TaggedClass("TransactionMetadatumLabels")("TransactionMetadatumLabels", {
  fromLabels: /*#__PURE__*/Schema.mutable(/*#__PURE__*/Schema.Array(TransactionMetadatumLabel))
}) {
  toJSON() {
    return {
  ...
  [Equal.symbol](that) {
    return that instanceof TransactionMetadatumLabels && this.fromLabels.length === that.fromLabels.length && this.fromLabels.every((label, i) => label === that.fromLabels[i]);
  }
  [Hash.symbol]() {
 ...
 * @category utils
 */
export const describeTransactionMetadatumLabel = label => {
  return _LABEL_DESCRIPTIONS.get(label);
};
//# sourceMappingURL=TransactionMetadatumLabels.js.map