...
export interface SigningWalletEffect extends ReadOnlyWalletEffect {
     ...
     */
    readonly signTx: (tx: Transaction.Transaction | string, context?: {
    ...
    readonly signMessage: (address: CoreAddress.Address | RewardAddress.RewardAddress, payload: Payload) => Effect.Effect<SignedMessage, WalletError>;
}
/**
 ...
 */
export declare function makeWalletFromSeed(network: Network, seed: string, options?: {
...
export {};
//# sourceMappingURL=WalletNew.d.ts.map