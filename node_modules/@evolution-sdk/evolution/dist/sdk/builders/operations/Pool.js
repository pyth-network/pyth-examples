 ...
 * @category programs
 */
export const createRegisterPoolProgram = params => Effect.gen(function* () {
 ...
 * @category programs
 */
export const createRetirePoolProgram = params => Effect.gen(function* () {
  const ctx = yield* TxContext;
  ...
  yield* Effect.logDebug(`[RetirePool] Added PoolRetirement certificate for pool ${PoolKeyHash.toHex(params.poolKeyHash)} at epoch ${params.epoch}`);
});
