 ...
 * @category programs
 */
export const createMintAssetsProgram = params => Effect.gen(function* () {
 ...
 * @internal
 */
export const mintToAssets = mint => {
 ...
 * @internal
 */
export const negatedMintAssets = mint => {
  if (!mint || mint.map.size === 0) {
    return Assets.fromLovelace(0n);
  }
  const record = {};
