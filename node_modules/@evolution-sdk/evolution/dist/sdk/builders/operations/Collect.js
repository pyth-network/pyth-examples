 ...
 * @category programs
 */
export const createCollectFromProgram = params => Effect.gen(function* () {
  ...
  const plutusScriptUtxos = scriptUtxos.filter(utxo => {
    ...
    const refScript = state.referenceInputs.find(ref => ref.scriptRef && ScriptHash.toHex(ScriptHash.fromScript(ref.scriptRef)) === scriptHashHex);
