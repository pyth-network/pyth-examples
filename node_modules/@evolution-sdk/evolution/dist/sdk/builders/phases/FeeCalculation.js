 ...
 */
export const executeFeeCalculation = () => Effect.gen(function* () {
  ...
  yield* Effect.logDebug(`[FeeCalculation] Starting fee calculation with ${baseOutputs.length} base outputs + ${buildCtx.changeOutputs.length} change outputs`);
  ...
  const refScriptFee = yield* calculateReferenceScriptFee([...state.selectedUtxos, ...state.referenceInputs], costPerByte);
