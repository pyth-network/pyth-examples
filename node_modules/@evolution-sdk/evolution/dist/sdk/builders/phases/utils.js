 ...
 * @category utilities
 */
export function calculateCertificateBalance(certificates, poolDeposits) {
 ...
 * @category utilities
 */
export function calculateWithdrawals(withdrawals) {
  let total = 0n;
 ...
 * @category utilities
 */
export function calculateProposalDeposits(proposalProcedures) {
