...
export interface ProviderEffect {
     ...
     */
    readonly getUtxosWithUnit: (addressOrCredential: CoreAddress.Address | Credential.Credential, unit: string) => Effect.Effect<Array<CoreUTxO.UTxO>, ProviderError>;
    /**
     ...
     */
    readonly awaitTx: (txHash: TransactionHash.TransactionHash, checkInterval?: number, timeout?: number) => Effect.Effect<boolean, ProviderError>;
    /**
