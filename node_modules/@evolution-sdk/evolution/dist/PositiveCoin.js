 ...
 * @category schemas
 */
export const PositiveCoinSchema = /*#__PURE__*/Schema.BigInt.pipe(Schema.filter(value => value >= MIN_POSITIVE_COIN_VALUE && value <= MAX_POSITIVE_COIN_VALUE)).annotations({
  message: issue => `PositiveCoin must be between ${MIN_POSITIVE_COIN_VALUE} and ${MAX_POSITIVE_COIN_VALUE}, but got ${issue.actual}`,
 ...
 * @category predicates
 */
export const is = /*#__PURE__*/Schema.is(PositiveCoinSchema);
/**
...
//# sourceMappingURL=PositiveCoin.js.map