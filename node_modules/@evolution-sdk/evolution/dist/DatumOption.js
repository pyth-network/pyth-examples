 ...
 * @category schemas
 */
export const DatumOptionSchema = /*#__PURE__*/Schema.Union(DatumHash.DatumHash, InlineDatum.InlineDatum).annotations({
 ...
 * @category testing
 */
export const arbitrary = /*#__PURE__*/FastCheck.oneof(DatumHash.arbitrary, InlineDatum.arbitrary);
export const CDDLSchema = /*#__PURE__*/Schema.Union(/*#__PURE__*/Schema.Tuple(/*#__PURE__*/Schema.Literal(0n), CBOR.ByteArray),
/*#__PURE__*/
// [0, Bytes32]
Schema.Tuple(/*#__PURE__*/Schema.Literal(1n), /*#__PURE__*/CBOR.tag(24, Schema.Uint8ArrayFromSelf)) // [1, tag(24, bytes)] - PlutusData as bytes in tag 24
);
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, Schema.typeSchema(DatumOptionSchema), {
  strict: true,
  encode: toA => E.gen(function* () {
    const result = toA._tag === "DatumHash" ? [0n, toA.hash] // Encode as [0, Bytes32]
    : [1n, {
      _tag: "Tag",
      tag: 24,
      value: PlutusData.toCBORBytes(toA.data)
    }]; // Encode as [1, tag(24, bytes)]
    return yield* E.right(result);
  }),
  decode: ([tag, value], _, ast) => E.gen(function* () {
    if (tag === 0n) {
      // Decode as DatumHash
      return yield* E.right(new DatumHash.DatumHash({
        hash: value
      }, {
      ...
      if (taggedValue._tag !== "Tag" || taggedValue.tag !== 24) {
        return yield* E.left(new ParseResult.Type(ast, [tag, value], `Invalid InlineDatum format: expected tag 24, got ${taggedValue._tag} with tag ${taggedValue.tag}`));
      }
      return yield* E.right(new InlineDatum.InlineDatum({
...
//# sourceMappingURL=DatumOption.js.map