 ...
 * @category schemas
 */
export class ScriptRef extends /*#__PURE__*/Schema.TaggedClass()("ScriptRef", {
 ...
 * @category schemas
 */
export const FromBytes = /*#__PURE__*/Schema.transform(Schema.Uint8ArrayFromSelf, Schema.typeSchema(ScriptRef), {
  strict: true,
  decode: bytes => new ScriptRef({
    bytes
  }, {
...
export const CDDLSchema = /*#__PURE__*/CBOR.tag(24, Schema.Uint8ArrayFromSelf);
/**
 ...
 * @category schemas
 */
export const FromCDDL = /*#__PURE__*/Schema.transformOrFail(CDDLSchema, /*#__PURE__*/Schema.typeSchema(ScriptRef), {
  strict: true,
  encode: (_, __, ___, toA) => Effect.succeed({
    _tag: "Tag",
    tag: 24,
    value: toA.bytes // Use the bytes directly
  }),
  decode: taggedValue => Effect.succeed(new ScriptRef({
 ...
 * @category parsing
 */
export const fromBytes = bytes => Schema.decodeSync(FromBytes)(bytes);
/**
 ...
 * @category parsing
 */
export const fromHex = hex => Schema.decodeSync(FromHex)(hex);
/**
 ...
 * @category encoding
 */
export const toBytes = data => Schema.encodeSync(FromBytes)(data);
/**
 ...
 * @category encoding
 */
export const toHex = data => Schema.encodeSync(FromHex)(data);
/**
