import { AssetName, Data, DatumOption, Schema, TSchema } from "@evolution-sdk/evolution";
...
const PythStateDatum = TSchema.Struct({
    ...
    deprecated_withdraw_scripts: TSchema.Map(TSchema.PlutusData, TSchema.PlutusData),
    withdraw_script: TSchema.ByteArray
});
export async function getPythState(policyId, client) {
 ...
 */ export function getPythScriptHash(pythState) {
