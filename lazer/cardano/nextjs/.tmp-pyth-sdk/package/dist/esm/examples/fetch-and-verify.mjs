/** biome-ignore-all lint/suspicious/noConsole: code example */ import process from "node:process";
import { createClient, ScriptHash, TransactionHash } from "@evolution-sdk/evolution";
import { PythLazerClient } from "@pythnetwork/pyth-lazer-sdk";
import yargs from "yargs";
import { hideBin } from "yargs/helpers";
import { getPythScriptHash, getPythState } from "../index.mjs";
 ...
 * @returns
 */ export function createEvolutionClient(network, provider) {
    return createClient({
        network,
        provider: {
            ...provider,
...
const { network, policyId: POLICY_ID, lazerToken: LAZER_TOKEN, provider: providerType, providerToken } = await yargs(hideBin(process.argv)).option("network", {
    choices: [
        "mainnet",
        "preprod",
        "preview"
