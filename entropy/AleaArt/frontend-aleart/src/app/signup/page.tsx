    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-black/80 backdrop-blur-sm rounded-3xl p-12 w-full max-w-lg relative z-10 border border-gray-800">
        <div className="text-center mb-10">
          ...
          <p className="text-2xl text-gray-300" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400 }}>Create your account</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <label htmlFor="name" className="block text-lg font-medium text-white mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400 }}>
              Full Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-lg font-medium text-white mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400 }}>
              Confirm Password
            </label>
            <input
              type="password"
